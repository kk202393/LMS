...
MIDDLEWARE = [
    ...
    # 'LMS.middleware.SessionTimeoutMiddleware',
...
AXES_LOCKOUT_TEMPLATE = '/home/ubuntu/lmsServer/LMS/templates/index.html'
...
AXES_COOLOFF_TIME = 1  # in minutes, adjust as needed
