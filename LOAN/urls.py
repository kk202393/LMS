...
urlpatterns = [
    ...
    path("create_new_branch/", views.CreateNewBranch, name="create_new_branch"),
    ...
    path("agent_branch/", views.Agentbranch),
    ...
    path("Loan_Summary_Report/", views.Loan_Summary_Report, name="Loan_Summary_Report"),
